...
<div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p">
    <div class="text-center">
        <img src="{{ url('assets/img/Kouloughli-logo.png') }}" alt="{{ setting('app_name') }}" height="50">
    </div>
...
@section('scripts')
    {!! JsValidator::formRequest('Kouloughli\Http\Requests\Auth\PasswordRemindRequest', '#remind-password-form') !!}
@stop
