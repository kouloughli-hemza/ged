        ...
        <div class="form-group mb-4">
            <div class="d-flex align-items-center">
                <div class="custom-control custom-switch">
                    ...
                    {!! Form::checkbox('throttle_enabled', 1, setting('throttle_enabled'), ['class' => 'custom-control-input', 'id' => 'switch-throttle']) !!}
                    <label for="switch-throttle" class="custom-control-label"></label>
                </div>
