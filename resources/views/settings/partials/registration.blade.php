        ...
        <div class="form-group mb-4">
            <div class="d-flex align-items-center">
                <div class="custom-control custom-switch">
                    ...
                    <label for="switch-reg-enabled" class="custom-control-label"></label>
                </div>
        ...
        {{--<div class="form-group my-4">
            <div class="d-flex align-items-center">
                <div class="custom-control custom-switch">
                    ...
                    {!! Form::checkbox('tos', 1, setting('tos'), ['class' => 'custom-control-input', 'id' => 'switch-tos']) !!}
                    <label for="switch-tos" class="custom-control-label"></label>
                </div>
                <div class="ml-3 d-flex flex-column">
        ...
        <div class="form-group my-4">
            <div class="d-flex align-items-center">
                <div class="custom-control custom-switch">
                    ...
                    {!! Form::checkbox('reg_email_confirmation', 1, setting('reg_email_confirmation'), ['class' => 'custom-control-input', 'id' => 'switch-reg-email-confirm']) !!}
                    <label for="switch-reg-email-confirm" class="custom-control-label"></label>
                </div>
                <div class="ml-3 d-flex flex-column">
                    <label class="mb-0">
