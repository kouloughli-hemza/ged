        ...
        <div class="form-group mb-4">
            <div class="d-flex align-items-center">
                 <div class="custom-control custom-switch">
                     ...
                     {!! Form::checkbox('remember_me', 1, setting('remember_me'),
        ...
        {{-- <div class="form-group my-4">
            <div class="d-flex align-items-center">
                <div class="custom-control custom-switch">
                    ...
                    {!! Form::checkbox('forgot_password', 1, setting('forgot_password'), ['class' => 'custom-control-input', 'id' => 'switch-forgot-pass']) !!}
                    <label for="switch-forgot-pass" class="custom-control-label"></label>
                </div>
                <div class="ml-3 d-flex flex-column">
