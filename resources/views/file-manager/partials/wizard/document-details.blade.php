{!! Form::open(['route' => 'files.scanner', 'id' => 'scanner-form','files' => 'true']) !!}
            {{ csrf_field() }}
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        {!! Form::select('importance', $importances,'',
                            ['class' => 'custom-select', 'id' => 'importance-scanner']) !!}
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" id="arrivee-scanner" class="form-control" name="date_arrivee"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" id="arriveeHour-scanner" class="form-control" name="heur_arrivee"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="custom-select" name="nombre_page">
                            <option disabled selected>@lang('Select number of pages')</option>
                ...
                {{-- End date_arrivee & heur_arrivee & nombre_page  --}}
                 <button type="submit" class="btn btn-primary" id="scannerSubmitBtn" style="display: none">@lang('Save')</button>

{!! Form::close()!!}

@push('custom-scripts')
    {!! JsValidator::formRequest('Kouloughli\Http\Requests\File\CreateFileFromScannerRequest', '#scanner-form') !!}
@endpush