        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">@lang('My Profile')</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('scripts')
    ...
    {!! JsValidator::formRequest('Kouloughli\Http\Requests\User\UpdateProfileLoginDetailsRequest', '#login-details-form') !!}
