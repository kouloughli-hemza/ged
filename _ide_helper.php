    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
                        /** @var \Kouloughli\Console\Kernel $instance */
...
namespace Kouloughli\Services\Auth\TwoFactor { 
    ...
    class Facade {
         ...
         *
         * @param \Kouloughli\Services\Auth\TwoFactor\TwoFactorAuthenticatable $user
         * @return bool 
         * @static 
         */ 
        public static function isEnabled($user)
        {
                        /** @var \Kouloughli\Services\Auth\TwoFactor\Authy $instance */
         ...
         *
         * @param \Kouloughli\Services\Auth\TwoFactor\Contracts\Authenticatable $user
         * @return mixed 
         * @static 
         */ 
    ...
    class JWTAuth {
        ...
        public static function attempt($credentials)
        {
            //Method inherited from \Tymon\JWTAuth\JWTAuth            
                        /** @var \Kouloughli\Services\Auth\Api\JWTAuth $instance */
         ...
         *
         * @param bool $forceForever
         * @return \Kouloughli\Services\Auth\Api\JWTAuth 
         * @static 
         */ 
...
namespace  { 
    ...
    class Authy extends \Kouloughli\Services\Auth\TwoFactor\Facade {}
