...
Route::group(['middleware' => ['registration', 'guest']], function () {
    ...
    Route::post('register', 'Auth\RegisterController@registerDirection');
});
...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::resource('directions', 'DirectionsController')->middleware('permission:directions.manage');

    /**
     * File Manager
     */

    Route::group(['prefix' => 'files', 'middleware' => 'permission:files.create'], function () {


        Route::get('/', 'Files\FilesController@index')
            ->name('files.index');

        Route::post('/store', 'Files\FilesController@store')
            ->name('files.store');

        Route::post('/scanner/store', 'Files\FilesController@documentScannerData')
            ->name('files.scanner');

        Route::get('/{file}/edit', 'Files\FilesController@edit')
            ->name('files.edit');

        Route::put('/{file}/update', 'Files\FilesController@update')
            ->name('files.update');
        ...
        Route::get('prefetch', 'Files\FilesController@autocompletePrefetch')->name('prefetch');

        Route::get('prefetch', 'Files\FilesController@autocompletePrefetch')->name('prefetch');

        Route::get('list-view', 'Files\FilesController@listView')->name('list.view');
    ...
    Route::post('dark-mode', 'SettingsController@darkMode')->name('setting.dark');
