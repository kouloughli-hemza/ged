...
namespace Kouloughli\Support\Authorization;
...
trait AuthorizationUserTrait
{
    ...
    {
        return $this->belongsTo(Role::class, 'role_id','ref_role');
    }
    ...
    {
        $availablePermissions = $this->role->cachedPermissions()->pluck('perm_name')->toArray();
    ...
    public function setRole($role)
    {
        return $this->forceFill([
            'role_id' => $role instanceof Role ? $role->ref_role : $role
        ])->save();
    }
}
