...
use Kouloughli\Events\Settings\Updated as SettingsUpdated;
...
class SettingsController extends Controller
{
    ...
    /**
     * Enable Or disable Dark Mode Style for user
     * @param Request $request
     * @return \Illuminate\Http\RedirectResponse
     */
    public function darkMode(Request $request)
    {
        $request->darkMode == 1 ? Session::put('darkMode','enabled') : Session::forget('darkMode');
