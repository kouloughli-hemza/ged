...
namespace Kouloughli\Repositories\User;

use Kouloughli\Repositories\Role\RoleRepository;
use Kouloughli\Role;
use Kouloughli\Services\Auth\Social\ManagesSocialAvatarSize;
...
class EloquentUser implements UserRepository
{
    ...
    {
        return User::leftJoin('social_logins', 'users.ref_user', '=', 'social_logins.user_id')
            ->select('users.*')
    ...
    {
        return User::leftJoin('sessions', 'users.ref_user', '=', 'sessions.user_id')
            ->select('users.*')
    ...
    public function paginate($perPage, $search = null, $status = null)
    {
        ...
        $result = $query->orderBy('ref_user', 'desc')
            ->paginate($perPage);
