...
class EloquentRoleTest extends TestCase
{
    ...
    {
        $this->expectsEvents(\Kouloughli\Events\Role\Updated::class);
    ...
    {
        $this->expectsEvents(\Kouloughli\Events\Role\Deleted::class);
    ...
    {
        $role = factory(Role::class)->create();
        $permissions = factory(\Kouloughli\Permission::class)->times(2)->create();
